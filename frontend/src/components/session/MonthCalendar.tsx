...
export function MonthCalendar({ sessions, currentDate, selectedDate, onSelectDate, onShiftMonth }: Props) {
        ...
        {cells.map((d) => {
          ...
          return (
            <button
              ...
              className={`border-t border-l border-[#EFEFEF] h-[40px] md:h-[80px] p-1 md:p-1.5 flex flex-col items-stretch text-left transition-colors hover:bg-[#FAFAFA] ${
